...
ggplot(data=CI, aes(x=Escapement, y=Median)) +
  ...
  geom_point(data=parameters_fig, aes(x=S_median, y=R_median),pch=16, size=3) +
  theme(text=element_text(size=17)) +
  geom_text(size=3, data=parameters_fig, aes(x=S_median, y=R_median, label=year,family="Times",

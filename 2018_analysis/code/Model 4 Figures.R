...
profile <-function(i,z,xa.start, xa.end,lnalpha.c, beta){ 
  ...
  ggsave("figures/Model 4/0.7.AR.png", dpi=200, width=8, height=5, units='in')
  ...
  Y %>% 
    ...
    theme(legend.justification=c(1,0), legend.position=c(1,.5), 
          legend.key = element_blank(),legend.title=element_blank())
  ggsave("figures/Model 4/0.8.AR.png", dpi=200, width=8, height=5, units='in')
  ...
  Y %>% 
    ...
    theme(legend.justification=c(1,0), legend.position=c(1,.5), 
          legend.key = element_blank(),legend.title=element_blank())
  ggsave("figures/Model 4/0.9.AR.png", dpi=200, width=8, height=5, units='in')
  ...
  ggsave("figures/Model 4/0.8_0.9.png", dpi=200, dev='png', width=7, height=6, units='in')
  ...
  ggsave("figures/Model 4/expected_sustained_yield.png", dpi=200, width=8, height=5, units='in')
}
#Run function
...
png(file='figures/Model 4/Escapement.png', res=200, width=8, height=9, units ="in") 
...
Fig_d<-Fig_d+geom_line(aes(y=Parameters$log.resid_val2.5pc), colour="grey70", linetype="dotted", size=0.5)+
  ...
  geom_line(aes(y=Parameters$log.resid_val2.5pc), colour="grey70", linetype="dotted", size=0.5)+
...
Fig_d<-Fig_d+scale_y_continuous(breaks = seq(-2.5, 2, 0.5), limits = c(-2.5, 2))+scale_x_continuous(breaks=seq(min(Parameters$Year, na.rm=TRUE),
                                                                                                           max(Parameters$Year+1, na.rm=TRUE),5))                       
...
png(file='figures/Model 4/Point Estimates.png', res=200, width=8, height=11, units ="in") 
...
png(file='figures/Model 4/Proportions.png', res=200, width=8, height=11, units ="in") 
...
png(file='figures/Model 4/Horsetail_Plot.png', res=200, width=6, height=4, units ="in")  
grid.newpage()
...
png(file='figures/Model 4/Horsetail_Plot_Reconfig.png', res=200, width=6, height=4, units ="in")  
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,1)))
vplayout<-function(x,y) viewport (layout.pos.row=x, layout.pos.col=y)
...
Fig_a<-Fig_a+geom_line(aes(y=SEQ), colour="grey50", size=1, linetype=1)+
  annotate("rect", xmin = min(Parameters$Year), xmax = max(Parameters$Year)+1, ymin = LowerB, ymax = UpperB,
           alpha = .3)
png(file='figures/Model 4/Historical Escapement Plot.png', res=200, width=6, height=4, units ="in")  
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,1)))
vplayout<-function(x,y) viewport (layout.pos.row=x, layout.pos.col=y)
...
png(file='figures/Model 4/test.png', res=200, width=6, height=4, units ="in")  
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,1)))
vplayout<-function(x,y) viewport (layout.pos.row=x, layout.pos.col=y)
print(Fig,vp=vplayout(1,1:1)) 
...
png(file='figures/Model 4/Goal_Comparison.png', res=200, width=6, height=4, units ="in")  
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,1)))
vplayout<-function(x,y) viewport (layout.pos.row=x, layout.pos.col=y)
print(Fig,vp=vplayout(1,1:1)) 
